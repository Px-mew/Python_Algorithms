...
def merge(my_list, left, mid, right):
    """
        ...
        Две части массива "сливаются" в одну в порядке возрастания. Изменения записываются в исходный массив.
    """
...
def sort_merge(my_list, left, right):
    """
        Аргументы функции: массив, индекс первого элемента для обработки, длина обрабатываемой части.
        Разделение массива на малые части: рекурсивное делиние пополам, пока не останется 1 элемент в подмассиве.
